...
TF_CAPI_EXPORT extern void TF_GraphToFlatGraphDef(
    TF_Graph* graph, TF_Buffer* output_flat_graph_def, TF_Status* status);
...
// TF_GraphImportGraphDefWithResults() and
// TF_GraphImportFlatGraphDefWithResults().
...
// Deletes a results object returned by TF_GraphImportGraphDefWithResults() and
// TF_GraphImportFlatGraphDefWithResults.
...
// Import the graph serialized in `graph_def` and a list of additional
// `node_def` into `graph`.  Returns nullptr and a bad status on error.
// Otherwise, returns a populated TF_ImportGraphDefResults instance. The
// returned instance must be deleted via TF_DeleteImportGraphDefResults().
TF_CAPI_EXPORT extern TF_ImportGraphDefResults*
TF_GraphImportFlatGraphDefWithResults(TF_Graph* graph,
                                      const TF_Buffer* flat_graph_def,
                                      const TF_ImportGraphDefOptions* options,
                                      TF_Status* status);
